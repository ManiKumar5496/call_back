...
class Database {
    ...
    private $db_user = "papayaco_phonepecallback";  // Change as required
    private $db_pass = "papayaco_phonepecallback";  // Change as required 
    private $db_name = "papayaco_phonepecallback"; // Change as required
